...
def run():
    # 客户端配置
    client_cfg = IoTClientConfig(server_ip='a162830804.iot-mqtts.cn-north-4.myhuaweicloud.com',
                                 device_id='6283a90bacbbb071174f1ef7_mqtt',
    ...
    def property_set_callback(request_id, payload):
        ...
        service_property.add_service_property(service_id="Basedate", property='name', value="zhouguangwei")
